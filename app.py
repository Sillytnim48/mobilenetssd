...
lineaccesstoken = 'umOXHx8lCzQB/CcPFFMKmf1sbW6YfplTy44m3f1OTf1iHRxzVMwbwbrELaR4SNOUDQ4QoEcIWwMU3x7IYD1Thle4hziD1OrO2P/6WEaMYSfE9XppCG8aOiaMtdrBNg4FJq6KlHhBZkO+bcVjPJsaJAdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,jason_line):
    ...
    if msgType == "text":
        ...
        if (msg == "หวัดดี") :
            ...
            replyObj = TextSendMessage(text="กินข้าวๆๆๆๆ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif (msg == "อร่อยป่ะ") :
            replyObj = TextSendMessage(text="อร่อยยยย")
            line_bot_api.reply_message(rtoken, replyObj)
        else :
            headers = request.headers
            json_headers = ({k:v for k, v in headers.items()})
            json_headers.update({'Host':'bots.dialogflow.com'})
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/a52e0718-fedc-44d9-aaf8-de732427c0c6"
